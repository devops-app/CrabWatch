  ...
  return (
    <>
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-ocean-900">Missions</h1>
        ...
        <div className="space-y-4">
          {missions.length === 0 ? (
            <div className="card text-center py-12">
              ...
              <p className="text-gray-400 text-sm mt-2">Check back tomorrow for new missions!</p>
            </div>
          ) : (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  {!mission.claimed && !mission.completed && (
                    ...
                    >
                      {actionLoading === mission.key ? 'Claiming...' : 'Claim'}
                    </button>
                  )}
                  {mission.completed && (
        ...
        <div className="card">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-lg font-semibold text-ocean-800">Onboarding Progress</h2>
              <span className="text-sm text-gray-500">
                {onboarding.completedCount}/{onboarding.totalCount} steps
              </span>
            </div>
              ...
              >
                ...
                {!step.completed && index === onboarding.completedCount && (
                  <button
                    ...
                    className="px-4 py-2 bg-ocean-600 text-white rounded-lg text-sm hover:bg-ocean-700 transition-colors disabled:opacity-50"
                  >
                    {actionLoading === step.step ? 'Completing...' : 'Mark Complete'}
                  </button>
                )}
                {step.completed && (
