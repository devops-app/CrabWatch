...
export const CAPTURE_STEPS: Array<{ key: PhotoView; label: string; hint: string; required: boolean }> = [
...
export function getConfidenceTone(confidence: number): { label: string; className: string } {
  if (confidence >= 0.8) {
