...
export async function generateInsights(userId: string, locale?: string): Promise<Insight[]> {
  ...
  if (user.lastActiveDate) {
    ...
    if (daysSinceActive >= 2 && user.currentStreak > 0) {
      insights.push({
        ...
        type: 'STREAK_WARNING',
        title: i18n.t('streakWarning.title', { ns: 'insights', lng }),
        description: i18n.t('streakWarning.description', { ns: 'insights', lng, streak: user.currentStreak }),
        actionText: i18n.t('streakWarning.actionText', { ns: 'insights', lng }),
  ...
  if (nextMilestone) {
    ...
    insights.push({
      ...
      type: 'MILESTONE',
      title: i18n.t('milestone.title', { ns: 'insights', lng, remaining, milestone: nextMilestone }),
      description: i18n.t('milestone.description', { ns: 'insights', lng, progress }),
      actionText: i18n.t('milestone.actionText', { ns: 'insights', lng }),
      actionUrl: '/dashboard/capture',
 ...
 // Species diversity suggestion
  ...
  if (speciesCount < 3) {
    insights.push({
      id: `diversity-${userId}`,
      type: 'SUGGESTION',
      title: i18n.t('diversity.title', { ns: 'insights', lng }),
      description: i18n.t('diversity.description', { ns: 'insights', lng, count: speciesCount }),
      priority: 'low',
  ...
  if (prevWeekCount > 0 && lastWeekCount < prevWeekCount) {
    insights.push({
      ...
      type: 'SUGGESTION',
      title: i18n.t('activityDrop.title', { ns: 'insights', lng }),
      description: i18n.t('activityDrop.description', { ns: 'insights', lng, current: lastWeekCount, previous: prevWeekCount }),
      actionText: i18n.t('activityDrop.actionText', { ns: 'insights', lng }),
      actionUrl: '/dashboard/capture',
      priority: 'medium',
